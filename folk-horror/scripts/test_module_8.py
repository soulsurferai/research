...
print("-" * 80)
result = quick_export("The Witch", output_dir='/Users/USER/Desktop/JAMES/Noetheca/Reviews/insights')

# Test 2: Check if file was created
import os
test_file = '/Users/USER/Desktop/JAMES/Noetheca/Reviews/insights/the_witch.json'
